...
// void erase_4k(at45_t *dev, uint32_t address);
// void erase_64k(at45_t *dev, uint32_t address);
// void erase_all(at45_t *dev, uint32_t address);
// void at45_read(at45_t *dev, uint32_t address, uint8_t *buffer, uint32_t length);
// void at45_write(at45_t *dev, uint32_t address, uint8_t *buffer, uint32_t length);
// void at45_power(at45_t *dev, bool on);
